...
Transcription Pipeline: Audio → Text + Speaker Identification
Vector Storage: Text → Embeddings → Qdrant Database
Retrieval System: Query → Relevant Meeting Segments
LLM Integration: Context + Query → Natural Language Answer
Web Interface: User-friendly access to the system
...
bashCopygit clone https://github.com/yourusername/meeting-context-chatbot.git
...
bashCopydocker run -p 6333:6333 -p 6334:6334 qdrant/qdrant:latest
Usage
Transcribe a Meeting
bashCopypython transcribe.py --audio_file "path/to/meeting.wav" --hf_token "your_huggingface_token"
Process and Store a Transcript
bashCopypython store_chunk.py --file "path/to/transcript.json" --id "meeting-id"
Answer Questions via Command Line
bashCopypython answer_with_groq.py "What were the main points discussed in the meeting?"
